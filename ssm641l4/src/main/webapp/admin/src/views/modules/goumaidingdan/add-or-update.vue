<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="自取时间" prop="ziqushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.ziqushijian" 
                type="datetime"
                placeholder="自取时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.ziqushijian" label="自取时间" prop="ziqushijian">
              <el-input v-model="ruleForm.ziqushijian" 
                placeholder="自取时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='ziqushijian'){
            this.ruleForm.ziqushijian = obj[o];
	    this.ro.ziqushijian = true;
            continue;
          }
          if(o=='clicknum'){
