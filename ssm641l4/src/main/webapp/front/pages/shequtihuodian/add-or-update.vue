	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`shequtihuodian`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
																																																																																																if(this.ruleForm.id){
					await this.$api.update(`shequtihuodian`, this.ruleForm);
				}else{
					await this.$api.add(`shequtihuodian`, this.ruleForm);
				}
