<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="shangpinyuanjia">
          <el-input v-model="ruleForm.shangpinyuanjia" 
              placeholder="商品原价" clearable  :readonly="ro.shangpinyuanjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品原价" prop="shangpinyuanjia">
              <el-input v-model="ruleForm.shangpinyuanjia" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品现价" prop="shangpinxianjia">
          <el-input v-model="ruleForm.shangpinxianjia" 
              placeholder="商品现价" clearable  :readonly="ro.shangpinxianjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品现价" prop="shangpinxianjia">
              <el-input v-model="ruleForm.shangpinxianjia" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="团购最低人数" prop="tuangouzuidirenshu">
          <el-input v-model="ruleForm.tuangouzuidirenshu" 
              placeholder="团购最低人数" clearable  :readonly="ro.tuangouzuidirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="团购最低人数" prop="tuangouzuidirenshu">
              <el-input v-model="ruleForm.tuangouzuidirenshu" 
                placeholder="团购最低人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品折扣" prop="shangpinzhekou">
          <el-input v-model="ruleForm.shangpinzhekou" 
              placeholder="商品折扣" clearable  :readonly="ro.shangpinzhekou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品折扣" prop="shangpinzhekou">
              <el-input v-model="ruleForm.shangpinzhekou" 
                placeholder="商品折扣" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="团购开始时间" prop="tuangoukaishishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.tuangoukaishishijian" 
                type="datetime"
                placeholder="团购开始时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuangoukaishishijian" label="团购开始时间" prop="tuangoukaishishijian">
              <el-input v-model="ruleForm.tuangoukaishishijian" 
                placeholder="团购开始时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="团购结束时间" prop="tuangoujieshushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.tuangoujieshushijian" 
                type="datetime"
                placeholder="团购结束时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuangoujieshushijian" label="团购结束时间" prop="tuangoujieshushijian">
              <el-input v-model="ruleForm.tuangoujieshushijian" 
                placeholder="团购结束时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="可提货点" prop="ketihuodian">
          <el-select v-model="ruleForm.ketihuodian" placeholder="请选择可提货点">
            <el-option
                v-for="(item,index) in ketihuodianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="可提货点" prop="ketihuodian">
	      <el-input v-model="ruleForm.ketihuodian"
                placeholder="可提货点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      this.$http({
		...
		if(json.shangpumingcheng!=''&&json.shangpumingcheng){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/shequtihuodian/tihuodidian`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.ketihuodianOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.shangpinmiaoshu = this.ruleForm.shangpinmiaoshu.replace(reg,'../../../ssm641l4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
